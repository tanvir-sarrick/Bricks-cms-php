          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down">
				  <?php 
					...
					$nameRead = mysqli_query($db, $sql);
					while ( $row = mysqli_fetch_assoc($nameRead) ){
						$name = $row['name'];
						echo $name;
					}
				  ?>
				  ...
				  <?php 
							...
							while ( $row = mysqli_fetch_assoc($nameRead) ){
								...
								if(empty($image)){
									?>
										<img src="assets/img/users/emptyProfile.jpg" class="wd-32 rounded-circle">
									<?php
								}
								else{
									?>
										<img src="assets/img/users/<?php echo $image; ?>" class="wd-32 rounded-circle">
									<?php
								}
							}
						?>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
                ...
                <a href="">
					<?php 
						...
						while ( $row = mysqli_fetch_assoc($nameRead) ){
							...
							if(empty($image)){
								?>
									<img src="assets/img/users/emptyProfile.jpg" class="wd-80 rounded-circle">
								<?php
							}
							else{
								?>
									<img src="assets/img/users/<?php echo $image; ?>" class="wd-80 rounded-circle">
								<?php
							}
						}
					?>
              ...
              <ul class="list-unstyled user-profile-nav">
                <li><a href="editProfile.php"><i class="icon ion-ios-person"></i> Edit Profile</a></li>
